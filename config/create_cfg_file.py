...
config.set('Topology', 'clustering_mode', 'label')
config.set('Topology', 'model_selection', 'all_systems')
config.set('Topology', 'test_dataset', 'all_systems')
...
config.set('Clustering', 'classification_method', 'knn')
