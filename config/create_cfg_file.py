...
config.set('Topology', 'model_selection', 'hbase')
config.set('Topology', 'test_dataset', 'hbase')
config.set('Topology', 'test_dataset_split', '0.25')
...
config.set('Rendering', 'classes_of_interest', 'a- hw- sw-')
